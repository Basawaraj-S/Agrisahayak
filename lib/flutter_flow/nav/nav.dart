...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: FieldWidget.routePath,
          builder: (context, params) => FieldWidget(),
        ),
        FFRoute(
          name: StoragefinderWidget.routeName,
          path: StoragefinderWidget.routePath,
          builder: (context, params) => StoragefinderWidget(),
        ),
        FFRoute(
          name: NearbyshopsWidget.routeName,
          path: NearbyshopsWidget.routePath,
